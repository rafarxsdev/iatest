...
export default function Card({ card }: CardProps) {
  ...
  return (
    <div
      className="bg-surface-container-lowest rounded-xl p-5 shadow-[0_8px_24px_rgba(24,28,32,0.04)] transition-all hover:shadow-[0_12px_32px_rgba(24,28,32,0.08)] flex items-start justify-between gap-4"
    >
      <div className="flex-1">
        ...
        <h3 className="text-lg font-bold text-on-surface leading-tight mb-1">{card.title}</h3>
